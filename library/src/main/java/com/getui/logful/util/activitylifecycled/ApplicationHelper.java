...
/**
 * Helper for accessing in API level 14 in a backwards compatible fashion. When running on API level
 * 14 or above, the framework's implementations of these methods will be used.
 */
public final class ApplicationHelper {

    /**
     * Registers a callback to be called following the life cycle of the application's
