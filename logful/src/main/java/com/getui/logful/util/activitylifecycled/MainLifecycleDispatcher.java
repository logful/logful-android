 ...
 * 
 * Copyright (C) 2013 Benoit 'BoD' Lubek (BoD@JRAF.org) Copyright (C) 2006 The Android Open Source
 * Project
 * 
...
/**
 * Keeps a list of {@link ActivityLifecycleCallbacksCompat}s that will be called following the life
 * cycle of the application's {@link Activity activities}. This class is used when the app is
 * running on an older platform version that does not support
 */
public class MainLifecycleDispatcher implements ActivityLifecycleCallbacksCompat {
    ...
    private ArrayList<ActivityLifecycleCallbacksCompat> mActivityLifecycleCallbacks =
            new ArrayList<ActivityLifecycleCallbacksCompat>();
